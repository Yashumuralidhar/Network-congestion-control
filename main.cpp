...
// Routers inside cloud
	...
	setFont(GLUT_BITMAP_TIMES_ROMAN_24);
	glColor3f(255,255,255);
	drawstring(2.8,-2.9,0.0,"HACKER A");
	...
	setFont(GLUT_BITMAP_TIMES_ROMAN_24);
	glColor3f(255,255,255);
	drawstring(-3.5,1.5,0.0,"HACKER B");
...
void display()
{
	...
	setFont(GLUT_BITMAP_TIMES_ROMAN_24);
    glColor3f(0.0,1.0,1.0);
	drawstring(-2,1,0,"YASHASWINI M (USN : 1VA18CS057)");

	setFont(GLUT_BITMAP_TIMES_ROMAN_24);
    glColor3f(0.0,1.0,1.0);
	drawstring(-2,.5,0,"SHABANA AZME S (USN : 1VA18CS041)");

	setFont(GLUT_BITMAP_TIMES_ROMAN_24);
    glColor3f(0.0,1.0,1.0);
	drawstring(-2,0,0,"AADYA SINGH (USN : 1VA18CS001)");
